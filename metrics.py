...
class ConfusionMatrix:
    ...
    @plt_settings()
    def plot(self, normalize=True, save_dir="", names=(), on_plot=None, font_size=14, axis_font_size=16):
        """
        ...
        Args:
            ...
            font_size (int): The font size for annotations on the heatmap (default is 8).
            axis_font_size (int): The font size for axis labels and tick labels (default is 12).
        """
        ...
        seaborn.set_theme(font_scale=2.0 if nc < 50 else 1.8)  # for label size
        ...
        ax.set_xlabel("True", fontsize=axis_font_size)
        ax.set_ylabel("Predicted", fontsize=axis_font_size)
        ax.set_title("Confusion Matrix" + " Normalized" * normalize, fontsize=axis_font_size)

        # Set font size for x and y tick labels
        ax.set_xticklabels(ax.get_xticklabels(), fontsize=axis_font_size)
        ax.set_yticklabels(ax.get_yticklabels(), fontsize=axis_font_size)

        plot_fname = Path(save_dir) / f'confusion_matrix_{("normalized" if normalize else "raw")}.png'
