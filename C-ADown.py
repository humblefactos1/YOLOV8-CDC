...
class ADown2(nn.Module):
    def __init__(self, c1, c2):  # ch_in, ch_out, shortcut, kernels, groups, expand
        ...
        # self.depthwise = nn.Conv2d(c1 // 2, c1 // 2, kernel_size=3, stride=1, groups=c1 // 2, padding=1)
        # self.pointwise = nn.Conv2d(c1 // 2, self.c, kernel_size=1)
        # self.dilated_conv = nn.Conv2d(self.c, self.c, kernel_size=3, stride=2, padding=2, dilation=2)
    ...
    def forward(self, x):
        ...
        x2 = self.cv2(x2)
        x3 = torch.cat((x1, self.channel_shuffle(x2)), 1)
        return x3
